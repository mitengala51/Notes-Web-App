// // Complete Notes App Backend - Node.js + Express + MongoDB
// // Features: OTP-based signup with REAL email sending, email/password login, JWT auth, protected notes CRUD
...
//             <p style="font-size: 16px; color: #555;">Your One-Time Password (OTP) for Notes App registration is:</p>
...
//     // Generate default password hash (user will use OTP for login)
//     const saltRounds = 12;
//     const defaultPasswordHash = await bcrypt.hash('default-password-' + Date.now(), saltRounds);
